...
ActiveRecord::Schema.define(version: 2020_04_30_210705) do
  ...
  create_table "join_specialities", force: :cascade do |t|
    t.string "number_speciality"
    t.integer "doctor_id"
    t.integer "speciality_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["doctor_id"], name: "index_join_specialities_on_doctor_id"
    t.index ["speciality_id"], name: "index_join_specialities_on_speciality_id"
  end
